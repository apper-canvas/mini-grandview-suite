      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-slate-900 mb-2">Staff System Coming Soon</h3>
            <p className="text-secondary max-w-md mx-auto">
              Employee scheduling and task management system with shift planning, performance tracking, and communication tools.
            </p>
          </div>
        </CardContent>
      </Card>
